 ...
 * It creates two child threads and starts two runnable objects - Doctor and 
Clinic.
 ...
 * It prints the final output to report on average patient wait time and the total 
elapsed time
...
public class ClinicManager {
	...
	static long patientWaitTime = 0; // sum of time spent by all patients in
