...
public class Main {
	...
	static int binarySearch(double val, int[] arr) {
		int start = 0, end = arr.length - 1;
		int mid = 0;
		while(start != end) {
	...
	static int findFirstLargest(double val, int[] arr) {
		int start = 0, end = arr.length - 1;
		int mid = 0;
		while(start != end) {
	...
	public static void main(String[] args) {
		int[] arr = {1, 3, 4, 5, 7, 8, 8, 8, 8, 9, 10, 14, 17, 18, 22, 25, 26, 27, 30};
		int[] arr1 = {8, 6, 5, 4, 2};
		//int[] arr = {1, 3, 4, 6, 7, 8, 14, 15, 16, 17};
		System.out.println(arr[binarySearch(6.99, arr)]);
		System.out.println(arr[findFirstLargest(7.01, arr)]);
	}
